...
export const API_ENDPOINTS = {
  ...
  CULTURAL: {
    OVERVIEW: '/api/cultural/overview',
    CONTENT: {
      LIST: '/api/cultural/content',
      CREATE: '/api/cultural/content',
      BY_ID: (id: string) => `/api/cultural/content/${id}`,
      UPDATE: (id: string) => `/api/cultural/content/${id}`,
      DELETE: (id: string) => `/api/cultural/content/${id}`,
      UPDATE_STATUS: (id: string) => `/api/cultural/content/${id}/status`,
      INTERACT: (id: string) => `/api/cultural/content/${id}/interact`,
    },
    FEATURED: '/api/cultural/featured',
    POPULAR: '/api/cultural/popular',
    RECENT: '/api/cultural/recent',
    SEARCH: '/api/cultural/search',
    ADVANCED_SEARCH: '/api/cultural/advanced-search',
    RECOMMENDATIONS: '/api/cultural/recommendations',
    CATEGORIES: '/api/cultural/categories',
    TYPES: '/api/cultural/types',
    TAGS: '/api/cultural/tags',
    BY_TYPE: (type: string) => `/api/cultural/type/${type}`,
    BY_CATEGORY: (category: string) => `/api/cultural/category/${category}`,
    STATS: '/api/cultural/stats',
    BULK: '/api/cultural/bulk',
  },
  TRANSPORT: {
    FLIGHTS: {
      SEARCH: '/api/transport/flights/search',
    },
    CARS: {
      SEARCH: '/api/transport/cars/search',
    },
    BUSES: {
      SEARCH: '/api/transport/buses/search',
    },
    SEARCH: '/api/transport/search',
    ROUTE_OPTIONS: '/api/transport/route-options',
    POPULAR_ROUTES: '/api/transport/popular-routes',
    BOOKINGS: {
      LIST: '/api/transport/bookings',
      CREATE: '/api/transport/bookings',
      BY_ID: (id: string) => `/api/transport/bookings/${id}`,
      UPDATE: (id: string) => `/api/transport/bookings/${id}`,
      CANCEL: (id: string) => `/api/transport/bookings/${id}/cancel`,
      MY_BOOKINGS: '/api/transport/my-bookings',
      UPCOMING: '/api/transport/upcoming',
      HISTORY: '/api/transport/history',
    },
    STATS: '/api/transport/stats',
  },
  ITINERARY: {
    OVERVIEW: '/api/itinerary/overview',
    LIST: '/api/itinerary',
    CREATE: '/api/itinerary',
    BY_ID: (id: string) => `/api/itinerary/${id}`,
    UPDATE: (id: string) => `/api/itinerary/${id}`,
    DELETE: (id: string) => `/api/itinerary/${id}`,
    SHARE: (id: string) => `/api/itinerary/${id}/share`,
    COPY: (id: string) => `/api/itinerary/${id}/copy`,
    OPTIMIZE: (id: string) => `/api/itinerary/${id}/optimize`,
    EXPORT: (id: string) => `/api/itinerary/${id}/export`,
    MY_ITINERARIES: '/api/itinerary/my-itineraries',
    PUBLIC: '/api/itinerary/public',
    SHARED: (token: string) => `/api/itinerary/shared/${token}`,
    SEARCH: '/api/itinerary/search',
    RECOMMENDATIONS: '/api/itinerary/recommendations',
